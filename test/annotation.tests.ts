...
describe('annotations', () => {
    ...
    describe("classes", () => {
        ...
        describe("httpTrigger", () => {
            ...
            it("corsConfig", () => {
                @httpTrigger({ route: '/v1/test', corsConfig: { headers: ['X-test'] } })
                class HttpTriggerTestClass { }
        ...
        describe("rest", () => {
            ...
            it("corsConfig", () => {
                @rest({ path: '/v1/test', corsConfig: { headers: ['X-test'] } })
                class ApiGatewayTestClass { }
        ...
        describe("aws", () => {
            it("type", () => {
                ...
                expect(runtimeValue).to.equal('nodejs24.x')
            ...
            it("all", () => {
                @aws({ type: 'nodejs24.x', memorySize: 100, timeout: 3 })
                class RuntimeTestClass { }
